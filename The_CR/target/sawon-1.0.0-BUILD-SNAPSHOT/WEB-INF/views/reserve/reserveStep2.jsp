...
<div class="contain">
	...
	<form action="insertRs.do" method="post" id="frmres">
		<table class="tb" border=1>
			...
			<tr>	
				<th>인원수</th>
				<td><input type="number" min="0" max="4" name="people"  required> 명</td>
			</tr>
			<tr>
				<th>객실타입-객실명</th>
...
- 비수기(성수기 외 기간) : 최초 1일 숙박 요금의 10%가 위약금으로 부과됩니다.</li>
		...
		<div class="allcheck">
			<input type="checkbox" name="ck1"><span>유의사항, 취소 및 환불 규정을 모두 확인해주세요.</span>
			<div class="move">
				<div class="pre"><a href="#">이전 페이지로 가기</a></div>
				<div class="button">
