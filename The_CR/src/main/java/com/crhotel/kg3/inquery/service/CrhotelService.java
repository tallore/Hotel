package com.crhotel.kg3.inquery.service;
...
public interface CrhotelService {
	ArrayList <QuestionVO> getAllBoard(Criteria cri) throws Exception;
	ArrayList<QuestionVO> searchBoard(String type, String keyword, Criteria cri);
